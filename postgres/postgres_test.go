...
func TestNew(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			id, err := str.Set(ctx, tt.args.id, shared.DatabaseName, insertedItem, &set.Set{})
			...
			assert.NoError(t, str.Get(ctx, tt.args.id, shared.DatabaseName, &retrievedItem, &get.Get{}))
			...
			assert.NoError(t, str.Get(ctx, tt.args.id, shared.DatabaseName, &retrievedUpdatedItem, &get.Get{}))
